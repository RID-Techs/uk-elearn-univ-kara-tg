...
export function Create_Quiz_Extension () {
    ...
    const handleQuizCreation = () => {
      ...
      if (quizContentRef.current) {
        ...
        typeInYourQuestion.placeholder = "Saisissez votre question ici…";
  ...
  if (quizContent) {
    ...
    for (const question of allQuestions) {
      ...
      if (textarea && textarea.value.trim() === "") {
        alert("Merci de compléter toutes les questions avant d’imprimer le quiz.");
        return;
      }
    }
  }
      ...
      <div className="page-wrapper">
        <div className="quiz-generated-msg-wrapper">
          <div className="quiz-generated-msg-holder">
            <p className="quiz-generated-msg">Généré par <a href="https://UK-Elearn-learning-space-front.onrender.com/">UK-Elearn</a> </p>
          </div>
        </div>
          ...
          <div className="progress-msg-holder">
            <div className="quiz-msg">
              <p><span id="create-quiz">Créez</span>, <span id="take-quiz">Testez-vous</span>, et <span id="learn-quiz">Progressez</span> <span id="effortlessly">facilement</span> avec <br /> <span id="quiz-title"><em>les quiz de vos cours</em></span></p>
            </div>
          </div>
        </div>

        {
          ...
          <form>
            <div className="quiz-input-group-holder">
              <label htmlFor="quiz-based">🌾📍Quiz basé sur :</label>
              <select value={quizBased} onChange={handleQuizBased} id="quiz-based" required>
                <optgroup>
                  <option value="">- Choisir -</option>
                  <option value="Un Cours Spécifique">Un Cours Spécifique</option>
                  <option value="Un Domaine">Un Domaine</option>
                  <option value="Une Culture Générale">Une Culture Générale</option>
                </optgroup>
              </select>
            </div>
            <div className="quiz-input-group-holder">
              <label htmlFor="quiz-topic">🧮🪴Titre ou Sujet du Quiz:</label>
            ...
            <div className="quiz-input-group-holder">
              <label htmlFor="quiz-target">👨‍🎓Cible (Étudiant, Passionné):</label>
...

             {
              ...
              <div className="progress-msg-holder">
                <div className="quiz-msg quiz-no-print-header">
                  <p>C{"'"}est parti 🤗🧩, <br /> {mainQuizCreateBtn ? "Vous êtes sur le point de créer" : "Vous êtes en train de construire"} un quiz pour le sujet : <span className="quiz-unit-title">{quizTopic}</span>🌴.</p>
                </div>
                <div className="quiz-print-header contribute-msg-holder">
                  <h3><span id="quiz-title">Quiz 🧮📑🧩</span></h3>
                  <p>Quiz basé sur : {quizBased} </p>
                  <p>Cible : {quizTarget} </p>
                  <p>Titre ou Sujet : <span className="print-quiz-unit-title">{quizTopic}</span> 🌴.</p>
                </div>
              </div>
            </div>
            ...
            <div onClick={handleQuizCreation} className="quiz-create">
                ...
                <div>
                  <button type="button" id="quiz-create-btn">Créer</button>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div className="container download-quiz-wrapper">
                    <div className="download-quiz-holder">
                      <div className="download-quiz-btn">
                        <button onClick={handlePrintWithAnswers} type="button" id="download-quiz-btn-with-answers">Télécharger le quiz avec réponses ⭜</button>
                        <button onClick={handlePrintWithoutAnswers} type="button" id="download-quiz-btn-without-answers">Télécharger le quiz sans réponses ⭜</button>
                      </div>
                    </div>
                  </div>
                  </>
